                ...
                <MarginTop>
                    <List>
                        <Grid className="grid-cols-1 md:grid-cols-2 gap-2.5 md:gap-3 lg:gap-4">
                            {[
                                `Podvozek: Mercedes-Benz nákladní podvozek 6 - 7 nápravový.`,
                                `Dosah výložníku: 70 m (6 - 7 dílné hydraulické výložní rameno).`,
                                `Výkon čerpadla: cca 180 - 220 m³ / h (dle konfigurace čerpací jednotky).`,
                                `Maximální čerpací tlak: až 100 - 120 bar.`,
                                `Typ čerpadla: dvoupístové hydraulické betonové čerpadlo s S - ventilem.`,
                                `Průměr betonového potrubí: DN 125 mm / DN 150 mm.`,
                                `Maximální výška čerpání: cca 65 - 70 m.`,
                                `Maximální vodorovný dosah: cca 450 - 550 m.`,
