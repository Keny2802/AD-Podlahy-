            ...
            <Section color="secondary">
                ...
                <MarginTop>
                    <Flex className="justify-center flex-col gap-2 md:gap-4 lg:gap-6">
                        ...
                        src="/fota/sekce/vozovy-park/vozovy-park-6-technicke-listy-1.jpg"
                        alt="Scania Pumi 7 m³ 28 m Technické listy číslo 1 společnosti AD Podlahy"
                        ...
                        src="/fota/sekce/vozovy-park/vozovy-park-6-technicke-listy-2.jpg"
                        alt="Scania Pumi 7 m³ 28 m Technické listy číslo 2 společnosti AD Podlahy"
                        className="w-full md:max-w-[400px] object-cover rounded-md"
                        />
                    </Flex>
                </MarginTop>
