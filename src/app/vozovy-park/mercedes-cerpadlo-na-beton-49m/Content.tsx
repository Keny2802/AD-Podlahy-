        ...
        <Fragment>
            ...
            <Section color="secondary">
                <FlexCol className="justify-center items-center text-center gap-2.5 md:gap-3 lg:gap-4">
                    <Heading>
                        Mercedes čerpadlo na beton 50 m
                    </Heading>
                    <BodyText>
                ...
                <MarginTop>
                    <Flex className="justify-center flex-col gap-2 md:gap-4 lg:gap-6">
                        <List>
                            <Grid className="grid-cols-1 gap-2.5 md:gap-3 lg:gap-4">
                                {[
                                    ...
                                    `Maximální výška čerpání: 50 m.`,
                                    `Maximální vodorovný dosah: 45 m.`,
                        ...
                        src="/fota/sekce/vozovy-park/vozovy-park-3-technicke-listy-1.jpg"
                        alt="Mercedes čerpadlo na beton 50 m Technické listy číslo 1 společnosti AD Podlahy"
                        ...
                        src="/fota/sekce/vozovy-park/vozovy-park-3-technicke-listy-2.jpg"
                        alt="Mercedes čerpadlo na beton 50 m Technické listy číslo 2 společnosti AD Podlahy"
                        className="w-full md:max-w-[400px] object-cover rounded-md"
                        />
                    </Flex>
                </MarginTop>
